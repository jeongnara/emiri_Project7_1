package kr.hs.emirimw2016.emiri_project7_1;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.item_img01:
                imgV.setImageResource(R.drawable.nara1);
                return true;
            case R.id.item_img02:
                imgV.setImageResource(R.drawable.nara2);
                return true;
            case R.id.item_img03:
                imgV.setImageResource(R.drawable.nara3);
                return true;
        }
